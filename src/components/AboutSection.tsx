            ...
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-white to-ai-50 dark:from-slate-800 dark:to-slate-700 p-8 rounded-2xl shadow-xl border border-gray-200/50 dark:border-slate-600/50">
                <div className="text-center">
                  <div className="w-24 h-24 bg-gradient-ai rounded-full mx-auto mb-6 flex items-center justify-center animate-pulse-ai">
                    <span className="text-white font-bold text-2xl">F</span>
                  </div>
                  <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Faizy Ahmed</h4>
